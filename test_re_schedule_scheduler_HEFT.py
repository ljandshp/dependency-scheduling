...
LastEditTime: 2021-04-20 17:01:50
...
def re_scheduling(is_draw=False,
    ...
    for _release_index,_release_time in enumerate(release_time_list):
        ...
        remain_length_list = utils.get_remain_length(_application.task_graph)
    ...
    # for i in application_list[5].task_graph.nodes():
    #     print("task: {0}".format(i))
    #     print(application_list[5].task_graph.nodes()[i])       
    
    # for u,v in application_list[5].task_graph.edges():
    #     print("edge: {0}-{1}".format(u,v))
    #     print(application_list[5].task_graph.edges()[u,v])

    # for i in range(edge_number):
    #     print(edge_list[i].upload_data_rate)

    # print("cloud transmission data rate: {0}".format(cloud.data_rate))  
    # draw.draw(application_list[5].task_graph)
